...
--
INSERT INTO
  `CLIENTES` (`CODIGO`, `NOME`, `CIDADE`, `ESTADO`, `ATIVO`)
VALUES
...
CREATE TABLE IF NOT EXISTS `PEDIDOSDET` (
  `CODIGO` INT(11) UNSIGNED,
  `SEQUENCIAL` INT(11) UNSIGNED,
  `CODPRODUTO` INT(11) UNSIGNED,
...
--
-- Create Index for table `PEDIDOSDET`
--
CREATE INDEX IDX_COD_PEDIDOSDET ON PEDIDOSDET(CODIGO);
