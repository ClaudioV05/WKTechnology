...
--
CREATE UNIQUE INDEX IDX_COD_CLIENTE ON CLIENTES(CODIGO);
...
--
CREATE UNIQUE INDEX IDX_COD_PRODUTO ON PRODUTOS(CODIGO);
...
--
CREATE UNIQUE INDEX IDX_COD_PEDIDOS ON PEDIDOS(CODIGO);
